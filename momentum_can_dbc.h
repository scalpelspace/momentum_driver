...
typedef enum {
  ...
  MOMENTUM_CAN_DBC_IDX_DATETIME_GET_RESPONSE = 12,
  MOMENTUM_CAN_DBC_IDX_RGB_LED_SET = 13,
  MOMENTUM_CAN_DBC_IDX_VERSION_GET = 14,
  MOMENTUM_CAN_DBC_IDX_VERSION_GET_RESPONSE = 15,
